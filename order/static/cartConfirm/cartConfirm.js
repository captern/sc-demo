(function(win,$){
    ...
    $(".submit-btn").on("tap",function(){
        ...
        $.post("http://m.kaluli.com/order/cartSubmit",{cart_data:cart_data,address_id:address_id,remark:remark,card_id:card_id,express_type:express_type,wx_code:wx_code,wx_openid:wx_openid},function(data){
            if(data.status == 1){
    ...
    function cartJson(callback){
        ...
        $.post("/order/cartFreight",{data:cart_data,address_id:address_id,card_id:card_id,express_type:express_type},function(data){
