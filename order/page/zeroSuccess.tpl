...
{%block name="content"%}
    <img width="100%" style="marign:0;display: block" src="/static/lingyuangou/lingyuangou_success.jpg" >
    ...
    var openid =$('input[name="openid"]').val(); // 微信主人的openid
    var nickname = $('input[name="nickname"]').val(); // 微信主人的昵称
    var shareTitle =  '卡路里喊你领摇摇杯啦';
    var shareDes = '卡路里喊你领摇摇杯啦！';
    wx.ready(function(){
        ...
        wx.onMenuShareAppMessage({
            ...
            desc: shareDes, // 分享描述
            link:  'http://m.kaluli.com/activity/lingyuangou', // 分享链接
            imgUrl: 'http://kaluli.hoopchina.com.cn/images/kaluli/shareImg.jpg', // 分享图标
