...
$(function(){
    ...
    var shareTitle = $('#shareTitle').text();//分享的标题
    var shareDes = $('#shareAbstract').text();//分享的概述
    var shareImage = $('#shareImage').attr('src');//分享的banner
    var shareLink = document.URL;//分享的链接
    wx.ready(function(){
