...
{%require name="activity:static/guoqing/index.scss"%}
{%require name="common:static/js/underscore/underscore.js"%}
{%require name="activity:static/guoqing/data.js"%}
{%require name="activity:static/guoqing/index.js"%}
{%/block%}

{%block name="content"%}
<section class="pagewrap guoqing">
    <div class="head"><img src="/static/guoqing/guoqinghead.jpg" /></div>
    <div class="content">
                ...
                <ul class="fn-clearfix">
                    ...
                    <li>
                        <a href="<@= prolist[s].link @>">
                            ...
                            <div class="proprice"><i>¥</i><@= prolist[s].discount_proprice @></div>
